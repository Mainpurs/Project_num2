...
def welcome(message):
    ...
    if str(user_id) not in data:
        data[str(user_id)] = {}
    data[str(user_id)] = {'name': '', 'story1_loc1': '', 'story1_loc2': '', 'story1_loc3': '', 'story1_loc4': '', 'story1_final': '', 'story2_loc1': '', 'story2_loc2': '', 'story2_loc3': '', 'story2_loc4': '', 'story2_final': ''}
...
def loc4(message):
    ...
    if data[str(user_id)]["story1_loc1"] == '1':
        msg = bot.send_message(message.chat.id,
                               'Никого нет, но тебе удалось выбраться и обойти мутантов. И захматить пару артефактов.\n'
